...
send=tk.Button(window, text="Send Mail", command=SendMail  ,fg="red"  ,bg="yellow"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 12, ' bold '))
send.place(x=1100, y=50)
...
copyWrite.insert("insert", "Developed by Himanshu")
